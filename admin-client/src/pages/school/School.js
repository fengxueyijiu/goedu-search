    ...
    return (
      <div className='single page'>
        ...
        <div className='white-block details'>
          ...
          <div className='block'>
            <div className='label'>校方账号</div>
            <div>{school.manager ? school.manager.email : ''}</div>
          </div>
          <div className='block'>
          ...
          <div className='block'>
            ...
            <div>{moment(school.settledExpiredDate).format('YYYY-MM-DD kk:mm:ss')}</div>
          </div>
          {
            school.hot ? (
              <ManageExpiredDate
