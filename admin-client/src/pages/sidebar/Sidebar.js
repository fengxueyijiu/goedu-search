    ...
    return (
      <Sider className='sidebar' style={{backgroundColor: '#fff'}}>
        ...
        >
          ...
          <SubMenu key='goods' title={<span><Icon type='file' /><span>商品管理</span></span>}>
            <Menu.Item key='/dashboard/goods/hot'>热门商品</Menu.Item>
            <Menu.Item key='/dashboard/goods/cats'>商品分类</Menu.Item>
          </SubMenu>

          <SubMenu key='activity' title={<span><Icon type='file' /><span>活动管理</span></span>}>
            <Menu.Item key='/dashboard/activities'>活动列表</Menu.Item>
          </SubMenu>
