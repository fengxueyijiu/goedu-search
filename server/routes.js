...
const shops = require('./api/v1/shops')
const managers = require('./api/v1/managers')
const goods = require('./api/v1/goods')
const goodsCats = require('./api/v1/goods-cats')
...
router.post('/schools/search', schools.search)
...
// 店铺详情
router.get('/shops/:shopId', shops.single)
// 删除店铺
router.delete('/shops/:shopId', requireAdmin, shops.delete)

// 设置热门商品
router.get('/goods/hot', goods.hot)
router.post('/goods/hot', requireAdmin, goods.markHot)
router.put('/goods/hot', requireAdmin, goods.unmarkHot)

// 商品详情
router.get('/goods/:goodsId', goods.single)
